...
Классический detector оказался недостаточно устойчив на разных биомах и освещении и был удалён вместе с HSV Lab. Поиск рамки выполняет только обученный oriented detector через ONNX Runtime. Поиск белой зоны и значка рыбы будет выполняться обычным OpenCV внутри найденной и выпрямленной OBB. Live capture уже подключён как отдельный источник кадров; tracking остаётся следующим этапом.
