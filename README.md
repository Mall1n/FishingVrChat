...
Каркас содержит диагностическое окно, загрузку статического изображения, контракты кадров и начальный безопасный controller. Обработка видео, OpenCV detector и live capture будут подключаться следующими этапами.
